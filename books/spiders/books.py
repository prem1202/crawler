...
class BooksSpider(scrapy.Spider):
    ...
    def products(self, response):
        ...
        item['brand2'] = response.css("div[class='-gallery'] a['class='link'] h2[class='title'] span[class='brand']::text").extract_first()
        item['sku'] = response.css("div[class='-gallery']::attr(data-sku)").extract_first()
